...
Uses st.fragment to prevent download buttons from refreshing the whole page.
"""
...
<style>
    ...
    .sub-header { text-align: center; color: #666; font-size: 14px; margin-top: -10px; margin-bottom: 30px; }
</style>
...
# ── Download section as a fragment (does NOT rerun the full page) ──
@st.fragment
def download_section():
    """This fragment reruns independently — clicking download won't refresh the whole page."""
