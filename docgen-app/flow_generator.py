...
# Draw.io shape styles — only using attributes that Lucidchart's importer
# preserves reliably (fillColor, strokeColor, shape, whiteSpace, html).
STYLES = {
    "terminal": "ellipse;whiteSpace=wrap;html=1;fillColor=#C8E6C9;strokeColor=#2E7D32;",
    "trigger":  "shape=parallelogram;perimeter=parallelogramPerimeter;whiteSpace=wrap;html=1;fillColor=#E3F2FD;strokeColor=#1F3864;",
    "process":  "rounded=1;whiteSpace=wrap;html=1;fillColor=#E3F2FD;strokeColor=#1F3864;",
    "decision": "rhombus;whiteSpace=wrap;html=1;fillColor=#FFF9C4;strokeColor=#F9A825;",
    # TBD = pure bright yellow fill + bold red border. Impossible to miss.
    "tbd":      "rounded=1;whiteSpace=wrap;html=1;fillColor=#FFEB3B;strokeColor=#C62828;strokeWidth=3;",
    "error":    "rounded=1;whiteSpace=wrap;html=1;fillColor=#FFCDD2;strokeColor=#C62828;",
}
...
def generate_flow_drawio(canonical):
    ...
    def style_for(base, *checks):
        return "tbd" if any("TBD" in str(c).upper() for c in checks) else base
